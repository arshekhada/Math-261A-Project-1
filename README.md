...
- ChatGPT used for brainstorm wording, clarify questions about R/Quarto syntax, and review draft code structure. I made sure that all final code and text reflect my own understanding and work.
- Stack Overflow for solutions to specific R errors and formatting issues when rendering with Quarto.
